...
<div class="container">
	<div class="wp_list_container">
		<div class="row">
            ...
            <img style="margin-top: -8px;" src="<?php echo base_url();?>images/icon_list.png" /> Tìm Kiếm </h3>
						</div>
					</div>
						...
						<div class="span">
							<div class="news_hot_catelogy_list_pages" style="margin-bottom: 34px; width: 100%; float: left; border-bottom: 2px solid rgb(233, 233, 233) ! important;">
								...
								<div class="img_news_hot_catelogy_list_pages"> 
									<div class="span3">
										<a href="<?php echo base_url();?>details/dic/<?php echo $value_content_list['id_content']; ?>/<?php echo $titlevalue_content_list; ?>/<?php echo $urlvalue_content_list; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_content_list['title_conent_vi']; ?>"> 
									...
									<div class="div_calss_anh">
										<a href="<?php echo base_url();?>details/dic/<?php echo $value_content_list['id_content']; ?>/<?php echo $titlevalue_content_list; ?>/<?php echo $urlvalue_content_list; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_content_list['title_conent_vi']; ?>"> <h3 class="news_hot_catelogy_list_pages_h3">	
