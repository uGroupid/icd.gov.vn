  ...
  <div class="row" style="padding:20px;">
	<div class="span5" style="margin-top: 0; float:left;">
		...
		<div style="float:right;">
			<h3 class="ten-cuc" style="">Cục Hợp tác quốc tế </h3>
			<h3  class="truc-thuoc" style="">Cơ quan của bộ văn hóa thể thao và du lịch </h3>
		</div>
      ...
      <?php 
			$data_footer = $this->callbuyMD->data_config_footer();
				foreach($data_footer as $value_data_footer){}
					echo  $value_data_footer['name_footer'];
			?>
    </div>
