						...
						<div class="span">
							<div class="news_hot_catelogy_list_pages" style="margin-bottom: 34px; width: 100%; float: left; border-bottom: 2px solid rgb(233, 233, 233) ! important;">
								...
								<div class="img_news_hot_catelogy_list_pages"> 
									<div class="span3">
										<a href="<?php echo base_url();?>details/dic/<?php echo $value_data_getcontent_category['id_content']; ?>/<?php echo $titlecs; ?>/<?php echo $url; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_data_getcontent_category['title_conent_en']; ?>"> 
											<img style="width: 100% ! important; width: 100% ! important;float: left;width: 60%;height: auto; margin-bottom: 20px;"class="img_content_news_hot_catelogy_list_pages" src="http://www3.icd.gov.vn/assets/uploads/content/<?php echo $value_data_getcontent_category['img']; ?>"  alt="<?php echo $value_data_getcontent_category['title_conent_en']; ?>" /> 
										</a>
									</div>
									<div class="div_calss_anh">
										<a href="<?php echo base_url();?>details/dic/<?php echo $value_data_getcontent_category['id_content']; ?>/<?php echo $titlecs; ?>/<?php echo $url; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_data_getcontent_category['title_conent_en']; ?>"> <h3 class="news_hot_catelogy_list_pages_h3">	
										<?php echo $value_data_getcontent_category['title_conent_en']; ?> </h3></a>
