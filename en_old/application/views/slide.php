		...
		<div id="myCarousel" class="carousel slide">
		  <div class="carousel-inner">
			...
			<div class="item active">
			  <img src="http://www3.icd.gov.vn/assets/uploads/slideshow/<?php echo $value_data_slideshows['img'];?>" alt="<?php echo $value_data_slideshows['title_slideshow_en'];?>">
			...
			?>
			<div class="item">
			  <img src="http://www3.icd.gov.vn/assets/uploads/slideshow/<?php echo $value_data_slideshow['img'];?>" alt="<?php echo $value_data_slideshow['title_slideshow_en'];?>">
