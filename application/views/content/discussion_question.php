...
<div class="container">
	<ol class = "breadcrumb">
	   ...
	   <li class = "active">Trao đổi và hỏi đáp</li>
									  ...
									  <div class="details_title_v1_home">
											...
											<form>
											  <div class="form-group">
												<label for="email_questions">Thư điện tử : </label>
												<input type="email" class="form-control" id="email_questions" placeholder="example@icd.com">
											  </div>
											  <div class="form-group">
												<label for="Questions">Tiêu đề câu hỏi : </label>
											  ...
											  <div class="form-group">
												<label for="Questions">Câu hỏi của bạn : </label>
