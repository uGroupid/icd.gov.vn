									...
									$images_lib = explode(",",$value_content_details['img']); ?>
									 <?php foreach($images_lib as $values_imageslib){ ?>
										<a href="http://www3.icd.gov.vn/assets/uploads/gallery/<?php echo $values_imageslib ?>" class="big">
											<img id="hover_lib" src="http://www3.icd.gov.vn/assets/uploads/gallery/<?php echo $values_imageslib ?>" alt=""  title='<div class="overout"><?php echo $value_content_details['title_album_images_en']; ?></div>' />
