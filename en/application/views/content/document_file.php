	...
	<div class="wp_list_container">
		<div class="row">
			...
			<div class="span8">
                ...
                <ul style="margin:0px;">
                    <?php foreach($datacontent as $value){} ?>
                    <span> <i><?php echo $value['description'];?></i></span>
                      
                       <p> <?php echo $value['content_vi'];?> </p>
                 
                      </br>
                      </hr>
                    <span style="float: left; width: 100%; margin: 20px auto; font-weight: bold;"> Tài liệu đính kèm: <a href=" <?php echo 'http://www3.icd.gov.vn/assets/uploads/file/'.$value['img'];?>"> Nhấn vào tải về</a></span>
            ...
            <div class="span">
              ...
              <br>
             <ul style="margin:0px;">
                    <?php foreach($datacontentlist as $value_datacontent){;?>
