	...
	<div class="wp_list_container">
		<div class="row">
					...
					<div class="span" id="heading_wp_list_container_left">
						<div class="heading_wp_list_container_left">
							...
							<h3 style="text-transform: uppercase; font-family: Helvetica Neue,Helvetica,Arial,sans-serif; color: #D90202 !important; width: 100%;" class="details_title_heading_wp_list_container_left">
								...
								<a style="text-transform: uppercase; font-family: Helvetica Neue,Helvetica,Arial,sans-serif; color: #D90202 !important; width: 100%;" href="<?php echo base_url();?>/category/dic/<?php echo $nametitles;?>/<?php echo $iddanhmuc;?>.icd" /> <?php echo $nametitle; ?> </a></h3>
						</div>
					</div>
						...
						<div class="span7">
							<div class="details_content_li_list_wp_list_container_left">
									<div class="details_content_list_content_pages">
									  ...
									  <div class="details_title_v1_home">
											...
											<p style='color: rgb(51, 51, 51); font-family: Arial,sans-serif; font-size: 12px; line-height: 20px;' class="details_title_home_center_layout3"> 
												<?php echo $value_content_details['introduction_en']; ?></p>
									...
									<div class="details_images_list_content_pages" >
										...
										<a style=" font-family: Arial,sans-serif; color: rgb(217, 2, 2); width: 100%;" href="#" title="<?php echo $value_content_details['title_conent_en']; ?>"> 
											<img style="width: 254px ! important; margin: auto;" class="details_img_content_v1_home" src="http://www3.icd.gov.vn/assets/uploads/content/<?php echo $value_content_details['img']; ?>"  alt="<?php echo $value_content_details['title_conent_en']; ?>" /> 
										</a>
										</div>
									</div>
			...
			<div class="span4">
                ...
                <a class="dropdown "  onclick="javascript:myLinkButtonClick();" href="javascript:void(0);" title="Các phòng nghiệp vụ, chuyên môn">The provision, expertise</a>
                <script>
                function myLinkButtonClick(){
                  $("#submedias").show();
								...
								<ul class="title-child">
									...
									<li><a  href="/en/page/ho_so_lanh_dao_cuc/4/lanh-dao-cuc-hop-tac-quoc-te.icd" title="Phòng Châu Âu">European Department</a></li>
