...
<div class="container">
	<ol class = "breadcrumb">
	   ...
	   <li><a href = "/page/gioi_thieu/1/cuc-hop-tac-quoc-te/cuc-hop-tac-quoc-te/5.icd">About Us</a></li>
...
<div class="container">
	<ol class = "breadcrumb">
	   ...
	   <li class = "active"><?php echo $datacontent[0]["title_conent_en"] ?></li>
	</ol>
</div>
<?php } ?>
<div class="container">
			...
			<div class="span8">
				<div class="wp_list_container_left">
						...
						<div class="span7">
							<div class="details_content_li_list_wp_list_container_left">
									<div class="details_content_list_content_pages">
									  ...
									  <?php echo $value_content_details['introduction_en'].$value_content_details['content_en']; ?>
									</div>
									</div>
                    ...
                    <a href="#" title="<?php // echo $value_content_details['title_conent_en']; ?>"> 
											<img class="details_img_content_v1_home" align="center"src="http://www3.icd.gov.vn/assets/uploads/content/<?php //echo //$value_content_details['img']; ?>"  alt="<?php //echo $value_content_details['title_conent_en']; ?>" /> 
										</a>
                    -->
										</div>
									</div>
