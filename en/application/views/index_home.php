...
font-size: 9px;
  ...
  <div class="container">
	  ...
	  <center style="margin-top: 48px; margin-bottom: 12px;">
		...
		<h3 class="home_logo_title_vi" style="margin-bottom: 25px;margin-top:0;">	<span>INTERNATIONAL COOPERATION DEPARTMENT</span> </h3>
		...
		<center>
			 <div class="email_dowload_index_value">
					...
					<img style="width: 60px; height: auto;" src="http://www3.icd.gov.vn/images/mail-icon.png"><span style="font-size: 14px;font-weight: bold;color: #FFF;position: relative;top: 3px">Mailbox</span></a>
                    <a style="width: 48%; float: left; background: #B80000  none repeat scroll 0% 0%; height: 40px;margin-left: 10px;" href="<?php echo base_url();?>share/"><img style="width: 30px; height: auto; margin-top: 5px;" src="<?php echo base_url();?>images/icon-download.png"><span style="font-size: 14px;font-weight: bold;color: #FFF;margin-left: 10px;position: relative;top:5px;"> <span> Download </span></span></a>
            </div>
		</center>
        </div>
					...
					<div class="spand_content_v1_home">
					  <div class="content_v1_home_index">
						...
						<div class="spak_lang_home">
							...
							<div class="task_list_home_news_packing"  task_list_home_news_packing> <span> </span><a href="http://icd.gov.vn/category/dic/van-hoa/11.icd">Culture </a></div>
						</div>
					</div>
				</li>
					...
					<div class="spand_content_v1_home" >
					  <div class="content_v1_home_index">
						...
						<div class="spak_lang_home">
							...
							<div class="task_list_home_news_packing" > <span> </span><a href="http://icd.gov.vn/category/dic/the-thao/12.icd">Sports </a></div>
						</div>
					</div>
				</li>
					...
					<div class="spand_content_v1_home" >
					  <div class="content_v1_home_index">
						...
						<div class="spak_lang_home">
							...
							<div class="task_list_home_news_packing"> <span> </span><a href="http://icd.gov.vn/category/dic/du-lich/13.icd">Tourism </a></div>
						</div>
					</div>
				</li>
					...
					<div class="spand_content_v1_home">
					  <div class="content_v1_home_index">
						...
						<div class="spak_lang_home">
							...
							<div class="task_list_home_news_packing"> <span> </span><a href="http://icd.gov.vn/category/dic/du-lich/20.icd">Family </a></div>
						</div>
					</div>
				</li>
        ...
        <div class="span4">
          <h3 class="text_headering_subhome">Featured News</h3>
...
<div class="home_task_container_video_callbuy" style="background: #fff;    margin-bottom: 20px;">
	<div class="container">
        ...
        <div class="span4">
				  <h3 class="text_headering_home_index">Upcomings Events</h3>
					<div class="vsub_text_headering_homeindex">
					  ...
					  <?php $url = to_slug($value_get_data_home_sukienchungtoi['title_conent_en']);?>
						<a href="<?php echo base_url();?>details/dic/<?php echo $value_get_data_home_sukienchungtoi['id_content']; ?>/su-kien-cua-chung-toi/<?php echo $url; ?>/<?php echo $value_get_data_home_sukienchungtoi['sub_menu']; ?>.icd" title="<?php echo $value_get_data_home_sukienchungtoi['title_conent_en']; ?>"> 
							<img src="http://www3.icd.gov.vn/assets/uploads/content/<?php echo $value_get_data_home_sukienchungtoi['img']; ?>"  style="width: 100%; height: 321px;" alt="<?php echo $value_get_data_home_sukienchungtoi['title_conent_en']; ?>" /> 
...
" class="content_v1_home_introductions">
							<h5 class="title_home_center_layout3">
								<?php echo mb_substr($value_get_data_home_sukienchungtoi['title_conent_en'],0,120,'UTF-8');?>
							</h5>
						</div>
          </a>
					</div>
         ...
         <div class="span4">
			...
			Our Events
			  ...
			  <div class="content_v1_home">
				<a href="<?php echo base_url();?>details/dic/<?php echo $value_get_data_home_sukienchungtoi['id_content']; ?>/su-kien-cua-chung-toi/<?php echo $url; ?>/<?php echo $value_get_data_home_sukienchungtoi['sub_menu']; ?>.icd" title="<?php echo $value_get_data_home_sukienchungtoi['title_conent_en']; ?>"> 
					...
					<div class="content_v1_home_introduction" style="width: 100%;">
					 <div class="title_v1_home">
						<a href="<?php echo base_url();?>details/dic/<?php echo $value_get_data_home_sukienchungtoi['id_content']; ?>/su-kien-cua-chung-toi/<?php echo $url; ?>/<?php echo $value_get_data_home_sukienchungtoi['sub_menu']; ?>.icd" title="<?php echo $value_get_data_home_sukienchungtoi['title_conent_en']; ?>"> 
							<h5 class="title_home_center_layout3"><?php echo mb_substr($value_get_data_home_sukienchungtoi['title_conent_en'],0,120,'UTF-8');?></h5>
						</a>
					  </div>
					</div>
			  </div>
				...
				<div class="span4">
					<h3 class="text_headering_home_index"><a href="http://icd.gov.vn/category/dic/tin-anh/31.icd">Photo News</a></h3>
					...
					<div class="tabsk_right_image_home">
						...
						<div class="content_v1_home_introductions">
							<h5 class="title_home_center_layout3">
								<?php echo mb_substr($value_tinanh_home['title_conent_en'],0,190,'UTF-8');?>
							</h5>
						</div>
          </a>
					</div>
...
<div class="container">
	<div class="row">
  <div class="span4">
				  <h3 class="text_headering_home_index">Event Calendar</h3>
					<div class="calendar_home" style="height: 179px ! important; float: left; width: 100%;">
						<?php echo $calendar;?>
					</div>
				</div>
        	<div class="span4">
			<h3 class="text_headering_home_index"><a href="http://icd.gov.vn/category/dic/the-gioi-voi-viet-nam/25.icd" style="">Overseas Vietnames and Viet Nam & the World</a></h3>
			<div class="vsub_text_headering_homeindex">
			  <?php 
				foreach($get_data_home_sukienchungtoi as $value_get_data_home_sukienchungtoi){} 
			  ?>
			  <?php $url = to_slug($value_get_data_home_sukienchungtoi['title_conent_en']);?>
				<a href="http://icd.gov.vn/category/dic/the-gioi-voi-viet-nam/25.icd" title="<?php echo $value_get_data_home_sukienchungtoi['title_conent_en']; ?>"> 
		...
		<div class="span4">
			<h3 class="text_headering_home_index"><a href="http://icd.gov.vn/video/dic/video-chung-toi/22.icd" style=""> Our Video</a></h3>
			<div class="vsub_text_headering_homeindex">
...
<div class="container">
  ...
  <div class="span4">
					<h3 class="text_headering_home_index"><a href="<?php echo base_url();?>gallery" style=""> Photo Library </a></h3>
				<div class="vsub_text_headering_homeindex">
		...
		<div class="span4">
			<h3 class="text_headering_home_index"><a href="http://icd.gov.vn/video/dic/video-tham-khao/23.icd" style=""> Reference video</a></h3>
			<div class="vsub_text_headering_homeindex">
