...
$.fn.simpleLightbox = function( options )
{
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		wrapper = $('<div>').addClass('sl-wrapper').addClass(options.className).html('<div class="hide_caption"><a style="padding-left: 8px; color: red;" id="title_hide_caption" href="#">Ẩn nội dung</a></div><div class="sl-image"></div>'),
   ...
   $( "div.sl-image" ).mouseover(function() {
                               $("div.sl-caption").hide();
                            }) .mouseout(function() {
                                 $("div.sl-caption").show();
                            });
