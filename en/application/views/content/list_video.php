		...
		<div class="row">
			...
			<div class="span8">
				<div class="wp_list_container_left">
					...
					<div class="row">
						<?php $urls = to_slug($hot_video['title_video_en']);
						...
						<div class="span8 vid-hot">
								...
								<a class="title-video" href="<?php echo base_url();?>details/video/<?php echo $hot_video['id']; ?>/<?php echo $urls; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $hot_video['title_video_en']; ?>"><span ><?php echo $hot_video['title_video_en']; ?></span> </a>
						</div>
					</div>
					<div class="row">
						<?php foreach($datacontent as $value_content_list): ?>
						<?php $urls = to_slug($value_content_list['title_video_en']);
						...
						?>
							<div class="span4 vid">
								...
								<a class="title-video" href="<?php echo base_url();?>details/video/<?php echo $value_content_list['id']; ?>/<?php echo $urls; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_content_list['title_video_en']; ?>"><span ><?php echo $value_content_list['title_video_en']; ?></span> </a>
							</div>
